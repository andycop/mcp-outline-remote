...
3. Register new application:
   ...
   - **Redirect URI**: `https://outline-mcp.your-domain.com/auth/outline/callback`
...
OUTLINE_OAUTH_AUTH_URL=https://outline.your-domain.com/oauth/authorize
OUTLINE_OAUTH_TOKEN_URL=https://outline.your-domain.com/oauth/token
