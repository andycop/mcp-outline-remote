...
3. **Configure Redirect URIs**
   - **Production**: `https://outline-mcp.your-domain.com/auth/outline/callback`
...
curl -X POST https://your-outline-instance.com/api/oauth/applications \
  ...
  -d '{
    ...
    "redirect_uris": ["https://outline-mcp.your-domain.com/auth/outline/callback"],
...
OUTLINE_OAUTH_REDIRECT_URI=https://outline-mcp.your-domain.com/auth/outline/callback
...
REDIRECT_URI=https://outline-mcp.your-domain.com/auth/callback
...
1. **Access the MCP Server**: Visit `https://outline-mcp.your-domain.com`
